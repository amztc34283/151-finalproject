...
# DVE full session
# Saved on Tue Nov 19 21:49:27 2019
# Designs open: 0
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{27 57} {1913 986}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 326} {height 683} {dock_state left} {dock_on_new_line true} {child_hier_colhier 224} {child_hier_coltype 105} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 211} {height 683} {dock_state left} {dock_on_new_line true} {child_data_colvariable 195} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1886} {height 150} {dock_state bottom} {dock_on_new_line true}}
